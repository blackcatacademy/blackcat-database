...
'@
      ...
      Upsert = @{
        ...
        Update = @('name','bio','photo_url','story','books_count','ratings_count',
                   'rating_sum','avg_rating','last_rating_at','deleted_at','updated_at','version')
      }
      UpdatedAt    = 'updated_at'
      SoftDelete   = 'deleted_at'
      DefaultOrder = 'id DESC'
...
'@
      ...
      Upsert = @{
        Keys   = @('tenant_id','slug_ci')  
        Update = @('name','parent_id','deleted_at','updated_at','version')
      }
      UpdatedAt    = 'updated_at'
      SoftDelete   = 'deleted_at'
      DefaultOrder = 'id DESC'
...
'@
      ...
      Upsert = @{
        Keys   = @('setting_key')  # PK
        Update = @('setting_value','type','section','description','is_protected','updated_by','updated_at','version')
      }
      UpdatedAt    = 'updated_at'
...
'@
      ...
      foreign_keys = @()
      Upsert = @{ Keys=@('name'); Update=@('type','location','status','last_seen','meta') }
      DefaultOrder = 'id DESC'
    }
...
'@
      ...
      Upsert = @{ Keys=@('id'); Update=@('status','items_total','items_ok','items_failed','error','started_at','finished_at') }
      DefaultOrder = 'created_at DESC'
    }
...
'@
      ...
      Upsert = @{ Keys=@('batch_id','event_key'); Update=@('status','error') }
      DefaultOrder = 'created_at DESC'
    }
...
'@
      ...
      foreign_keys = @()
      Upsert = @{ Keys=@('gid'); Update=@('guid','entity_table','entity_pk') }
      DefaultOrder = 'created_at DESC'
    }
...
'@
      ...
      foreign_keys = @()
      Upsert = @{ Keys=@('entity_table','field_name','action','keep_for'); Update=@('active','notes') }
      DefaultOrder = 'created_at DESC'
    }
...
'@
      ...
      Upsert = @{ Keys=@('id'); Update=@('status','processed_at','meta') }
...
'@
      ...
      foreign_keys = @()
      Upsert = @{ Keys=@('subject_type','subject_id','name','window_size_sec'); Update=@('limit_count','active') }
      DefaultOrder = 'created_at DESC'
    }
...
'@
      ...
      foreign_keys = @()
      Upsert = @{ Keys=@('subject_type','subject_id','name','window_start','window_size_sec'); Update=@('count','updated_at') }
...
'@
      ...
      Upsert = @{ Keys=@('fingerprint_hash'); Update=@('user_id','attributes','risk_score','last_seen','last_ip_hash','last_ip_key_version') }
      DefaultOrder = 'last_seen DESC'
    }
...
'@
      ...
      Upsert = @{
        Keys   = @('anchor_ref','anchor_type','merkle_root_id')
...
'@
      ...
      foreign_keys = @()
      Upsert = @{ Keys=@('system_name','component','version'); Update=@('checksum','applied_at','meta') }
...
'@
      ...
      foreign_keys = @()
      DefaultOrder = 'started_at DESC NULLS LAST'
    }
...
'@
      ...
      foreign_keys = @()
      Upsert = @{ Keys=@('name'); Update=@('priority','strategy','match','providers','active') }
...
'@
      indexes = @()
      foreign_keys = @()
      Upsert = @{ Keys=@('name'); Update=@('objective','target_pct','window_interval') }
      DefaultOrder = 'id DESC'
    }
