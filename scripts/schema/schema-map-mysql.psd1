...
'@
      indexes = @(
        # Keep the "_live" suffix aligned with the contract name used in generated PHP (Postgres uses a partial index of the same name)
...
'@
      ...
      Upsert = @{
      Keys   = @('user_id')     # PK
      Update = @('profile_enc','key_version','encryption_meta')
    }
    UpdatedAt    = 'updated_at'
...
'@
      ...
      Update = @('name','bio','photo_url','story','books_count','ratings_count',
                'rating_sum','avg_rating','last_rating_at','updated_at','version','deleted_at')
    }
    UpdatedAt    = 'updated_at'
    SoftDelete   = 'deleted_at'
    DefaultOrder = 'id DESC'
...
'@
      ...
      Upsert = @{
      Keys   = @('tenant_id','slug_ci')  
      Update = @('name','parent_id','updated_at','version','deleted_at')
    }
    UpdatedAt    = 'updated_at'
    SoftDelete   = 'deleted_at'
    DefaultOrder = 'id DESC'
...
'@
      ...
      Upsert = @{ Keys=@('tenant_id','book_id','category_id'); Update=@() }
...
'@
      ...
      Upsert = @{
      Keys   = @('id')  # PK CHAR(36)
      Update = @('user_id','note','updated_at','version')
    }
    UpdatedAt    = 'updated_at'
    DefaultOrder = 'created_at DESC'
    }
...
'@
      ...
      Upsert = @{
      Keys   = @('setting_key')  # PK
      Update = @('setting_value','type','section','description','is_protected','updated_at','updated_by','version')
    }
    UpdatedAt    = 'updated_at'
...
'@
      ...
      Update = @('user_id','email_hash_key_version','email_enc','email_key_version',
                ...
                'ip_hash','ip_hash_key_version','meta','updated_at','version')
    }
    UpdatedAt    = 'updated_at'
    DefaultOrder = 'id DESC'
    }
...
'@
      ...
      Upsert = @{
        Keys   = @('wrapper_uuid')
        Update = @('kms1_key_id','kms2_key_id','dek_wrap1','dek_wrap2','crypto_suite','wrap_version','status','rotated_at')
      }
      DefaultOrder = 'id DESC'
    }
...
'@
      ...
      Upsert = @{
        Keys   = @('event_key')
        Update = @('payload','status','attempts','next_attempt_at','processed_at','producer_node')
      }
      DefaultOrder = 'created_at DESC'
    }
...
'@
      ...
      foreign_keys = @()
      Upsert = @{
        Keys   = @('source','event_key')
        Update = @('payload','status','attempts','last_error','processed_at')
      }
      DefaultOrder = 'received_at DESC'
    }
...
'@
      ...
      Upsert = @{
        Keys   = @('audit_id')
        Update = @('chain_name','prev_hash','hash')
      }
      DefaultOrder = 'created_at DESC'
    }
...
'@
      ...
      foreign_keys = @()
      Upsert = @{
        Keys   = @('class','name','variant')
        Update = @('nist_level','status','params')
      }
      DefaultOrder = 'id DESC'
    }
...
'@
      ...
      Upsert = @{ Keys=@('policy_id','algo_id','role'); Update=@('weight','priority') }
...
'@
      ...
      Upsert = @{
        Keys   = @('name')
        Update = @('algo_id','public_key','private_key_enc','kms_key_id','origin','status','scope','activated_at','retired_at','notes')
      }
      DefaultOrder = 'id DESC'
    }
...
'@
      ...
      Upsert = @{
        Keys   = @('name')
        Update = @('algo_id','output_len','params','status')
      }
      DefaultOrder = 'id DESC'
    }
...
'@
      ...
      Upsert = @{ Keys=@('name'); Update=@('url','signing_key_id','status','last_synced_at','last_commit') }
      DefaultOrder = 'id DESC'
    }
...
'@
      ...
      Upsert = @{ Keys=@('repo_id','slug'); Update=@('name','description','version','status','updated_at') }
      UpdatedAt = 'updated_at'
      DefaultOrder = 'id DESC'
    }
...
'@
      ...
      Upsert = @{ Keys=@('role_id','permission_id'); Update=@('effect','source') }
...
'@
      ...
      Upsert = @{ Keys=@('user_id','role_id','tenant_id','scope'); Update=@('status','granted_by','granted_at','expires_at') }
...
'@
      ...
      Upsert = @{ Keys=@('user_id','permission_id','tenant_id','scope'); Update=@('effect','granted_by','granted_at','expires_at') }
      DefaultOrder = 'granted_at DESC'
    }
...
'@
      ...
      Upsert = @{ Keys=@('repo_id','commit_id'); Update=@('taken_at','metadata') }
...
'@
      ...
      Upsert = @{ Keys=@('repo_id','peer'); Update=@('last_commit','last_synced_at') }
    }
...
'@
      ...
      foreign_keys = @()
      Upsert = @{ Keys=@('entity_table','entity_pk','source'); Update=@('external_id') }
      DefaultOrder = 'created_at DESC'
    }
...
'@
      ...
      Upsert = @{ Keys=@('entity_table','field_name','effective_from'); Update=@('policy_id','notes') }
      DefaultOrder = 'effective_from DESC'
    }
...
'@
      ...
      Upsert = @{ Keys=@('alias'); Update=@('algo_id','notes') }
...
'@
      ...
      Upsert = @{
        Keys   = @('name')
        Update = @('type','location','status','last_seen','meta')
      }
      DefaultOrder = 'created_at DESC'
    }
...
'@
      ...
      Upsert = @{
      Keys   = @('id')
      Update = @('status','items_total','items_ok','items_failed','error','started_at','finished_at')
    }
      DefaultOrder = 'created_at DESC'
    }
...
'@
      ...
      Upsert = @{
        Keys   = @('gid')
        Update = @('guid','entity_table','entity_pk')
      }
      DefaultOrder = 'created_at DESC'
    }
...
'@
      ...
      Upsert = @{
      Keys   = @('id')
      Update = @('status','processed_at','meta')
    }
...
'@
      ...
      Upsert = @{
        Keys   = @('entity_table','entity_pk')
        Update = @('reason','hard_delete','scheduled_at','started_at','finished_at','status','error','created_by')
      }
      DefaultOrder = 'created_at DESC'
    }
...
'@
      ...
      foreign_keys = @()
      Upsert = @{
        Keys   = @('subject_type','subject_id','name','window_start','window_size_sec')
...
'@
      ...
      Upsert = @{
        ...
        Update = @('user_id','attributes','risk_score','last_seen','last_ip_hash','last_ip_key_version')
      }
      DefaultOrder = 'last_seen DESC'
    }
...
'@
      ...
      foreign_keys = @()
      Upsert = @{
        Keys   = @('system_name','component','version')
        Update = @('checksum','applied_at','meta')
      }
...
'@
      ...
      Upsert = @{
        Keys   = @('name')
        Update = @('priority','strategy','match','providers','active')
      }
      DefaultOrder = 'created_at DESC'
    }
...
'@
      ...
      Upsert = @{
        Keys   = @('name')
        Update = @('objective','target_pct','window_interval')
      }
      DefaultOrder = 'created_at DESC'
    }
...
'@
      ...
      Upsert = @{
        Keys   = @('window_id','computed_at')
        Update = @('sli_value','good_events','total_events','status')
      }
