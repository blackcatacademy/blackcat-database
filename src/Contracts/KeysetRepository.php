...
interface KeysetRepository
{
     ...
     * @param array{col:string,dir:'asc'|'desc',pk:string} $order primary ordering plus PK fallback
     * @param array{colValue:mixed,pkValue:mixed}|null $cursor previous cursor (null for the first page)
     * @param int $limit maximum number of rows to return
     * @return array{0:array<int,array<string,mixed>>,1:array{colValue:mixed,pkValue:mixed}|null}
     */
    public function paginateBySeek(Criteria $criteria, array $order, ?array $cursor, int $limit): array;
}
