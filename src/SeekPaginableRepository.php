...
/**
 * Optional capability: repositories that can do keyset/seek pagination natively.
 *
 * Semantics:
 * - Stable ordering by (order.col, order.pk) in the same direction for both.
 * - Cursor is **exclusive**: the next page starts strictly after (colValue, pkValue).
 * - Return `null` as the second tuple item when there is no further page.
