...
// Can be disabled by exporting PHPSTAN_USE_LOCAL_CORE=0 when local sources are outdated/broken.
$useLocalCore = getenv('PHPSTAN_USE_LOCAL_CORE');
$repoRoot = __DIR__;
if ($useLocalCore === false || $useLocalCore === '' || $useLocalCore === '0') {
    $overrides = [];
} else {
